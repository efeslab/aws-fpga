...
//Date        : Wed Sep 29 23:45:26 2021
//Host        : cilantro running 64-bit Ubuntu 20.04.3 LTS
//Command     : generate_target rr_cfg_axil_interconnect.bd
//Design      : rr_cfg_axil_interconnect
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module axi_interconnect_0_imp_6BUTND
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_1KNHAOX m00_couplers
  ...
  m01_couplers_imp_1SK8YTZ m01_couplers
       (.M_ACLK(axi_interconnect_0_ACLK_net),
        .M_ARESETN(axi_interconnect_0_ARESETN_net),
  ...
  s00_couplers_imp_152THIN s00_couplers
       (.M_ACLK(axi_interconnect_0_ACLK_net),
        .M_ARESETN(axi_interconnect_0_ARESETN_net),
  ...
  rr_cfg_axil_interconnect_xbar_2 xbar
...
module m00_couplers_imp_1KNHAOX
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module m01_couplers_imp_1SK8YTZ
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
(* CORE_GENERATION_INFO = "rr_cfg_axil_interconnect,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=rr_cfg_axil_interconnect,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=10,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "rr_cfg_axil_interconnect.hwdef" *) 
module rr_cfg_axil_interconnect
  ...
  axi_interconnect_0_imp_6BUTND axi_interconnect_0
       (.ACLK(ACLK_1),
        .ARESETN(ARESETN_1),
        .M00_ACLK(ACLK_1),
...
module s00_couplers_imp_152THIN
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
