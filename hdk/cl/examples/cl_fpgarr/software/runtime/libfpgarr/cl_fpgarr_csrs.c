...
#ifdef COUNT_DDR
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_A_AW);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_A_W);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_A_AR);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_A_R);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_A_B);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_B_AW);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_B_W);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_B_AR);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_B_R);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_B_B);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_C_AW);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_C_W);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_C_AR);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_C_R);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_C_B);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_D_AW);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_D_W);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_D_AR);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_D_R);
    LOG_INFO_DBG_CSR_U32("%d", RR_DDR_COUNTER_D_B);
#endif
}
