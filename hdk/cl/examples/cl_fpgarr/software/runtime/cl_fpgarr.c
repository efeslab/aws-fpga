...
void debug_check() {
    ...
    // mjc dbg_csr
    LOG_INFO_DBG_CSR_U64(RR_RECORD_IN_PKT_CNT);
    LOG_INFO_DBG_CSR_U64(RR_RECORD_OUT_PKT_CNT);
    LOG_INFO_DBG_CSR_U64(RR_RECORD_IN_BITS_CNT);
    LOG_INFO_DBG_CSR_U64(RR_RECORD_OUT_BITS_CNT);
    LOG_INFO_DBG_CSR_U64(RR_RECORD_IN_FIFO_OUT_PKT_CNT);
    LOG_INFO_DBG_CSR_U64(RR_RECORD_IN_FIFO_OUT_ORIG_BITS_CNT);
    LOG_INFO_DBG_CSR_U64(RR_RECORD_IN_FIFO_OUT_ALIGNED_BITS_CNT);
    LOG_INFO_DBG_CSR_U64(RR_WB_AW_TRANS_CNT);
    LOG_INFO_DBG_CSR_U64(RR_WB_W_TRANS_CNT);
    LOG_INFO_DBG_CSR_U64(RR_WB_B_TRANS_CNT);
    LOG_INFO_DBG_CSR_U64(RT_RECORD_UNHANDLED_SIZE);
    LOG_INFO_DBG_CSR_U64(RT_CURRENT_RECORD_UNHANDLED_SIZE);
    LOG_INFO_DBG_CSR_U64(RT_LEFTOVER_SIZE);
    LOG_INFO_DBG_CSR_U64(RT_RECORD_CURR);
    LOG_INFO_DBG_CSR_U64(RR_AXI_STATUS);
}
