...
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -filter {NAME =~ */CL/CL_DMA_PCIS_SLV/CL_TST_DDR_B/CL_TST/sync_rst_n_reg}] -clear_locs
...
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -filter {NAME =~ */CL/CL_PCIM_MSTR/PCI_AXI4_REG_SLC}]
...
add_cells_to_pblock [get_pblocks pblock_CL_bot] [get_cells -quiet -hierarchical -filter {NAME =~ */CL/CL_DMA_PCIS_SLV/PCI_AXL_REG_SLC || NAME =~ */CL/CL_OCL_SLV/AXIL_OCL_REG_SLC || NAME =~ */CL/CL_SDA_SLV/AXIL_SDA_REG_SLC}]
...
set pblock_cells [get_cells -quiet -hierarchical -filter {NAME =~ */CL/CL_DMA_PCIS_SLV/CL_TST_DDR_D/CL_TST/sync_rst_n_reg || NAME =~ */CL/CL_DMA_PCIS_SLV/CL_TST_DDR_D/CL_TST/pre_sync_rst_n_reg}]
