...
extern "C"
{
  ...
  {
    #pragma HLS INTERFACE m_axi port=inData      offset=slave bundle=gmem
    #pragma HLS INTERFACE m_axi port=result_x    offset=slave bundle=gmem
    #pragma HLS INTERFACE m_axi port=result_y    offset=slave bundle=gmem
    #pragma HLS INTERFACE m_axi port=result_w    offset=slave bundle=gmem
    #pragma HLS INTERFACE m_axi port=result_h    offset=slave bundle=gmem
