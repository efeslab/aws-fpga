...
#pragma HLS INTERFACE m_axi port=wt_i offset=slave bundle=gmem
#pragma HLS INTERFACE m_axi port=kh_i offset=slave bundle=gmem
#pragma HLS INTERFACE m_axi port=dmem_i offset=slave bundle=gmem
#pragma HLS INTERFACE m_axi port=dmem_o offset=slave bundle=gmem
#pragma HLS INTERFACE s_axilite port=wt_i bundle=control
#pragma HLS INTERFACE s_axilite port=kh_i bundle=control
#pragma HLS INTERFACE s_axilite port=dmem_i bundle=control
#pragma HLS INTERFACE s_axilite port=dmem_o bundle=control
#pragma HLS INTERFACE s_axilite port=n_inputs bundle=control
#pragma HLS INTERFACE s_axilite port=n_outputs bundle=control
#pragma HLS INTERFACE s_axilite port=input_words bundle=control
#pragma HLS INTERFACE s_axilite port=output_words bundle=control
#pragma HLS INTERFACE s_axilite port=layer_mode bundle=control
#pragma HLS INTERFACE s_axilite port=dmem_mode bundle=control
#pragma HLS INTERFACE s_axilite port=width_mode bundle=control
#pragma HLS INTERFACE s_axilite port=norm_mode bundle=control
