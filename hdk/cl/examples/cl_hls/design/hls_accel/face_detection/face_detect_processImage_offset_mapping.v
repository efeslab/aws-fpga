...
// ==============================================================
`timescale 1 ns / 1 ps
module face_detect_processImage_offset_mapping_rom (
addr0, ce0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3, addr4, ce4, q4, addr5, ce5, q5, addr6, ce6, q6, addr7, ce7, q7, addr8, ce8, q8, addr9, ce9, q9, addr10, ce10, q10, addr11, ce11, q11, clk);
...
initial begin
    $readmemh("./face_detect_processImage_offset_mapping_rom.dat", ram0);
    $readmemh("./face_detect_processImage_offset_mapping_rom.dat", ram1);
    $readmemh("./face_detect_processImage_offset_mapping_rom.dat", ram2);
    $readmemh("./face_detect_processImage_offset_mapping_rom.dat", ram3);
    $readmemh("./face_detect_processImage_offset_mapping_rom.dat", ram4);
    $readmemh("./face_detect_processImage_offset_mapping_rom.dat", ram5);
end
...
`timescale 1 ns / 1 ps
module face_detect_processImage_offset_mapping(
    reset,
    clk,
    address0,
    ce0,
...
face_detect_processImage_offset_mapping_rom face_detect_processImage_offset_mapping_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
