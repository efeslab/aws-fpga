...
// ==============================================================
`timescale 1 ns / 1 ps
module face_detect_processImage_bank_mapping_rom (
...
initial begin
    $readmemh("./face_detect_processImage_bank_mapping_rom.dat", ram0);
    $readmemh("./face_detect_processImage_bank_mapping_rom.dat", ram1);
    $readmemh("./face_detect_processImage_bank_mapping_rom.dat", ram2);
    $readmemh("./face_detect_processImage_bank_mapping_rom.dat", ram3);
    $readmemh("./face_detect_processImage_bank_mapping_rom.dat", ram4);
    $readmemh("./face_detect_processImage_bank_mapping_rom.dat", ram5);
end
...
`timescale 1 ns / 1 ps
module face_detect_processImage_bank_mapping(
    reset,
    clk,
    address0,
    ce0,
...
face_detect_processImage_bank_mapping_rom face_detect_processImage_bank_mapping_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
