...
set opt 1
set opt_options    "-bufg_opt -control_set_merge -hier_fanout_limit 512 -muxf_remap -aggressive_remap -propconst -retarget -sweep -merge_equivalent_drivers -carry_remap"
set opt_directive  ""
